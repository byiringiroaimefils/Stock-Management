        ...
        <div class="w-full max-w-md space-y-6 bg-white dark:bg-gray-800 p-8 rounded-lg ">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex flex-col space-y-4">
                    <x-primary-button
                        class="w-full inline-flex  items-center justify-center rounded-md text-sm font-medium ring-offset-background  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring  h-10 px-4 py-2">
                        {{ __('Log in') }}
                    </x-primary-button>
